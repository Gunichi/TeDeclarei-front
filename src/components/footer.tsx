...
export function Footer() {
  return (
    <footer className="bg-gradient-to-r from-purple-900 via-pink-900 to-rose-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 text-2xl font-bold mb-4">
              ...
              <span className="text-white">Te Declarei</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#how-it-works" className="text-gray-300 hover:text-pink-400 transition-colors">
                  Como Funciona
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/public-templates" className="text-gray-300 hover:text-pink-400 transition-colors">
                  Modelos Públicos
                </Link>
              </li>
            </ul>
